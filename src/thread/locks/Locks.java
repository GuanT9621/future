 ...
 *
 * 零、Java中的两种加锁的方式  synchronized关键字 与 接口Lock的实现类
 ...
 *      自Java 5之后，才在 java.util.concurrent.locks 包下有了另外一种方式来实现锁，那就是Lock（基于AbstractQueuedSynchronizer）。
 *
